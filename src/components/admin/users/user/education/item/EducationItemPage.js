...
class EducationItemPage extends Component {
  ...
  render() {
    return (
      <Fragment>
        <PageHeader>
          <PageTitle>Ścieżka edukacji</PageTitle>
        ...
        <Container>
          <Row>
            ...
            <Content>
              <Actions>
                <Link to={`/admin/users/${this.props.match.params.userId}/education/${this.props.match.params.educationItemId}/edit`} className="btn btn-primary">Edytuj</Link>
              </Actions>
              <Table>
                <TableBody>
                  <TableRow>
              ...
              <Heading>Kierunek studiów</Heading>
              <Table>
                <TableBody>
                  <TableRow>
                    <TableHeaderCell>Id</TableHeaderCell>
